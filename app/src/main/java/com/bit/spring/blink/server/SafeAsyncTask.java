...
public abstract class SafeAsyncTask<ResultT> implements Callable<ResultT> {
    ...
    protected void onSuccess( List<Map<String, Object>> t ) throws Exception {}
     ...
     *
     * @param e the exception thrown from {@link #onPreExecute()}, {@link #call()}, or {@link #onSuccess(List<Map<String, Object>>)}
    ...
    protected Task<ResultT> newTask() {
        return new Task<ResultT>((SafeAsyncTask<List<Map<String, Object>>>) this);
    }
    ...
    public static class Task<ResultT> implements Callable<Void> {
        ...
        protected SafeAsyncTask<List<Map<String, Object>>> parent;
        protected Handler handler;

        public Task(SafeAsyncTask<List<Map<String, Object>>> parent) {
            this.parent = parent;
        ...
        protected List<Map<String, Object>> doCall() throws Exception {
            return parent.call();
        }

        protected void doSuccess( final List<Map<String, Object>> r ) throws Exception {
            postToUiThreadAndWait( new Callable<Object>() {
                public Object call() throws Exception {
                    parent.onSuccess(r);
                    return null;
